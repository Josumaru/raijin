...
mixin _$AnimePopularEvent {
  ...
  TResult maybeWhen<TResult extends Object?>({
    TResult Function(String status, String order, String type)? animeGetPopular,
...
class _$AnimeGetPopularImpl implements _AnimeGetPopular {
  ...
  @override
  String toString() {
    return 'AnimePopularEvent.animeGetPopular(status: $status, order: $order, type: $type)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return animeGetPopular(status, order, type);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return animeGetPopular?.call(status, order, type);
  }
...
abstract class _AnimeGetPopular implements AnimePopularEvent {
  const factory _AnimeGetPopular(
      ...
      required final String type}) = _$AnimeGetPopularImpl;
