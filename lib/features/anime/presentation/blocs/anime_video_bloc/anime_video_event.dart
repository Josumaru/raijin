...
class AnimeVideoEvent with _$AnimeVideoEvent {
  const factory AnimeVideoEvent.getVideo({required String endpoint, required String baseUrl, required int position, required String server, String? videoPath}) = _GetVideo;
